...
| **Embla Carousel** | Carrossel touch-friendly |
...
```bash
# Clone o repositório
git clone https://github.com/seu-usuario/RedBull_PowerTrains.git

# Entre na pasta do projeto
cd RedBull_PowerTrains
...
### Tipografia
- **Display:** Orbitron (títulos futuristas)
- **Body:** Inter (textos legíveis)
